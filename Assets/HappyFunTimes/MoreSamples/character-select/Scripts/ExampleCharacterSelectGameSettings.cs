...
// in Unity.
public class ExampleCharacterSelectGameSettings : MonoBehaviour {

    public int areaWidth = 300;  // matches JavaScript
    public int areaHeight = 300;

    public static ExampleCharacterSelectGameSettings settings() {
        return s_settings;
    }

    static private ExampleCharacterSelectGameSettings s_settings;
