...
To use the HFTGamepad controller in your own projects keep everything above that says "see below".
...
"Switching Games" when the user is disconnected.

You are free to use that or delete it and write your own. If you write your own
